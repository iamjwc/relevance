...
describe RelevanceInterpreter do
  ...
  describe "single statement" do
    before(:each) do
      @r = RelevanceInterpreter.new "field('field1') == 'field1Value'"
    end
  ...
  describe "comparing two fields" do
    before(:each) do
      @r = RelevanceInterpreter.new "field('field1') == field('field2')"
    end
  ...
  describe "singular fields" do
    before(:each) do
      @r = RelevanceInterpreter.new "field('field1')"
    end
  ...
  describe "boolean operators" do
    before(:each) do
      @or  = RelevanceInterpreter.new "field('a') || field('b')"
      @and = RelevanceInterpreter.new "field('a') && field('b')"
      @not = RelevanceInterpreter.new "field('a') != field('b')"
    end
  ...
  describe "relational operators" do
    before(:each) do
      @lt = RelevanceInterpreter.new "field('a') < field('b')"
      @gt = RelevanceInterpreter.new "field('a') > field('b')"
      @lte = RelevanceInterpreter.new "field('a') <= field('b')"
      @gte = RelevanceInterpreter.new "field('a') >= field('b')"
    end
